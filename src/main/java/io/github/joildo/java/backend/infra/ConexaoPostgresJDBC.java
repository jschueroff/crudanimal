 ...
 */
package io.github.joildo.java.backend.infra;
...
public class ConexaoPostgresJDBC implements ConexaoJDBC {
    ...
    public ConexaoPostgresJDBC() throws SQLException, ClassNotFoundException {
        ...
        this.connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/help-me?ApplicationName=HelpMe", properties);
